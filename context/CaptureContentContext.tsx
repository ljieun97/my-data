...
export type CaptureMode = "news-cover" | "ranking-cover" | "ranking-cover-v2" | "ranking-cover-v3" | "release-board" | "movie-list" | "movie-collage";
...
export function getCaptureMovieMaxCount(captureMode: CaptureMode) {
  ...
  if (captureMode === "movie-collage") return 10;
