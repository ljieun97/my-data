...
export type CaptureMode = "news-cover" | "news-body" | "ranking-cover" | "ranking-cover-v2" | "poster-ranking" | "release-board" | "movie-list";

export function getCaptureMovieMaxCount(captureMode: CaptureMode) {
  if (captureMode === "release-board") return 8;
  if (captureMode === "poster-ranking") return 10;
