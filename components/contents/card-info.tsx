    ...
    <div className="browse-card group/footer relative overflow-hidden rounded-[24px] border shadow-none">
      ...
      <div className="p-0">
        <div className="flex items-start gap-3 p-3 pb-2">
          <img alt="poster" src={img} className="h-[6.8rem] w-[4.7rem] shrink-0 rounded-lg object-cover shadow-[0_12px_24px_rgba(15,23,42,0.16)]" />
        ...
        <div className="browse-card__footer flex items-center justify-between gap-2 border-t px-3 py-2">
          ...
          <div className="flex shrink-0 gap-2">
            <button type="button" className="browse-card__action rounded-full px-3 py-2" onClick={() => handleClick(1)}>
              <FontAwesomeIcon icon={faPlus} />
            </button>
            <button type="button" className="browse-card__detail rounded-full px-3 py-2" onClick={() => router.push(`/${type}/${id}`)}>
